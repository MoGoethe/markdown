...
var TOGGLEFULLSCREEN = exports.TOGGLEFULLSCREEN = 'TOGGLEFULLSCREEN';
var TOGGLEMDMODEL = exports.TOGGLEMDMODEL = 'TOGGLEMDMODEL';
var FRESHDOCUMENT = exports.FRESHDOCUMENT = 'FRESHDOCUMENT';
var GETEDITRODOM = exports.GETEDITRODOM = 'GETEDITRODOM';

var toggleFullsrceen = exports.toggleFullsrceen = function toggleFullsrceen() {
...
var toggleMDModel = exports.toggleMDModel = function toggleMDModel(model) {
	return function (dispatch) {
		dispatch({
			type: TOGGLEMDMODEL,
			model: model
...
var _preInputText = function _preInputText(text, preStart, preEnd, editorDom) {
	var start = editorDom.selectionStart;
	var end = editorDom.selectionEnd;
	var origin = editorDom.value;
...
var boldText = exports.boldText = function boldText(editorDom, dispatch) {
	dispatch(_preInputText("**加粗文字**", 2, 6, editorDom));
};

var italicText = exports.italicText = function italicText(editorDom, dispatch) {
	dispatch(_preInputText("_斜体文字_", 1, 5, editorDom));
};

var linkText = exports.linkText = function linkText(editorDom, dispatch) {
	dispatch(_preInputText("[链接文本](www.yourlink.com)", 1, 5, editorDom));
};

var blockquoteText = exports.blockquoteText = function blockquoteText(editorDom, dispatch) {
	dispatch(_preInputText("> 引用", 2, 4, editorDom));
};

var codeText = exports.codeText = function codeText(editorDom, dispatch) {
	dispatch(_preInputText("```\ncode block\n```", 4, 14, editorDom));
};

var pictureText = exports.pictureText = function pictureText(editorDom, dispatch) {
	dispatch(_preInputText("![alt](www.yourlink.com)", 2, 5, editorDom));
};

var listUlText = exports.listUlText = function listUlText(editorDom, dispatch) {
	dispatch(_preInputText("- 无序列表项0\n- 无序列表项1", 2, 8, editorDom));
};

var listOlText = exports.listOlText = function listOlText(editorDom, dispatch) {
	dispatch(_preInputText("1. 有序列表项0\n2. 有序列表项1", 3, 9, editorDom));
};

var headerText = exports.headerText = function headerText(editorDom, dispatch) {
...
var _ArticleTitle = __webpack_require__(109);

var _ArticleTitle2 = _interopRequireDefault(_ArticleTitle);

var _ArticleTags = __webpack_require__(108);

var _ArticleTags2 = _interopRequireDefault(_ArticleTags);

var _Marke = __webpack_require__(110);

var _Marke2 = _interopRequireDefault(_Marke);
...
var App = function App(state) {
	return _react2.default.createElement(
		...
		_react2.default.createElement(_ArticleTitle2.default, null),
		_react2.default.createElement(_ArticleTags2.default, null),
		_react2.default.createElement(_Marke2.default, { mdState: state })
	);
};
...
var _PanelMenuReducer = __webpack_require__(117);

var _PanelMenuReducer2 = _interopRequireDefault(_PanelMenuReducer);

var _MarkeReducer = __webpack_require__(115);

var _MarkeReducer2 = _interopRequireDefault(_MarkeReducer);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var Reducers = (0, _redux.combineReducers)({
	PanelMenuReducer: _PanelMenuReducer2.default,
	MarkeReducer: _MarkeReducer2.default
});
...
var ArticleTags = function ArticleTags() {
	return _react2.default.createElement(
		"div",
		{ className: "textbox tag-input" },
		_react2.default.createElement("input", { type: "text", className: "tags-textbox", placeholder: "\u6807\u7B7E\uFF0C\u5982JavaScript" }),
		_react2.default.createElement("span", { className: "hidden" })
	);
};
...
var ArticleTitle = function ArticleTitle() {
  return _react2.default.createElement(
    "div",
    { className: "editor-title" },
    _react2.default.createElement("input", { className: "textbox", name: "title", type: "text", placeholder: "\u6765\uFF0C\u53D6\u4E2A\u54CD\u4EAE\u7684\u6807\u9898\u5427" })
  );
};
...
var _PanelMenubar = __webpack_require__(112);

var _PanelMenubar2 = _interopRequireDefault(_PanelMenubar);

var _TextMenubar = __webpack_require__(113);

var _TextMenubar2 = _interopRequireDefault(_TextMenubar);
...
var Marke = function (_Component) {
	_inherits(Marke, _Component);
	...
	function Marke() {
		...
		_classCallCheck(this, Marke);

		for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
			args[_key] = arguments[_key];
		}

		return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Marke.__proto__ || Object.getPrototypeOf(Marke)).call.apply(_ref, [this].concat(args))), _this), _this._fresh = function (e) {
			_this.props.mdState.dispatch({
				type: _index.FRESHDOCUMENT,
				mdDocument: _this.refs.editor.value
			});
	...
	_createClass(Marke, [{
		...
		value: function render() {
			var state = this.props.mdState.state;
			var modelState = state.PanelMenuReducer.toJS();
			var markeState = state.MarkeReducer.toJS();
			var _dispatch = this.props.mdState.dispatch;
			return _react2.default.createElement(
				"div",
				{ className: modelState.isFullScreen ? "md-panel md-full-screen" : "md-panel" },
				_react2.default.createElement(
					"div",
					{ className: "md-menubar" },
					_react2.default.createElement(_TextMenubar2.default, { dispatch: _dispatch, editorDom: markeState.editorDom }),
					_react2.default.createElement(_PanelMenubar2.default, null)
				),
				_react2.default.createElement(
					"div",
					{ className: modelState.model },
					_react2.default.createElement(
						"div",
						{ className: "md-editor" },
						_react2.default.createElement("textarea", { id: "editor-area", onChange: this._fresh.bind(this), ref: "editor" })
					),
					_react2.default.createElement(
						"div",
						{ className: "md-preview" },
						_react2.default.createElement("div", { className: "markdown", dangerouslySetInnerHTML: { __html: markeState.mdDocument } })
					)
				)
			);
		}
...
var TextMenubarItem = function TextMenubarItem(_ref) {
	var isItem = _ref.isItem,
	    key = _ref.key,
	    title = _ref.title,
	...
	return isItem ? _react2.default.createElement(
		"li",
		{ key: key, className: isActive ? "menu-list-iem active" : "menu-list-iem", title: title, onClick: onClickAction },
		_react2.default.createElement("i", { className: itemClass })
	) : _react2.default.createElement("li", { key: key, className: "menu-list-iem span-line" });
};

exports.default = TextMenubarItem;
...
var PanelMenubar = function PanelMenubar(_ref) {
	var modelState = _ref.modelState,
	    toggleFullsrceen = _ref.toggleFullsrceen,
	    toggleMDModel = _ref.toggleMDModel;

	return _react2.default.createElement(
		"div",
		{ className: "panel-menubar" },
		_react2.default.createElement(
			"ul",
			{ className: "menu-list" },
			_react2.default.createElement(
				"li",
				{ className: "menu-list-iem", title: "\u5168\u5C4F", onClick: function onClick() {
						return toggleFullsrceen();
					} },
				_react2.default.createElement("i", { className: modelState.isFullScreen ? "fa fa-compress" : "fa fa-arrows-alt" })
			),
			_react2.default.createElement("li", { className: "menu-list-iem span-line" }),
			_react2.default.createElement(
				"li",
				{ className: modelState.isEditorModel ? "menu-list-iem active" : "menu-list-iem", title: "\u9884\u89C8\u6A21\u5F0F", onClick: function onClick() {
						return toggleMDModel("preview");
					} },
				_react2.default.createElement("i", { className: "fa fa-eye" })
			),
			_react2.default.createElement(
				"li",
				{ className: modelState.isMixinModel ? "menu-list-iem active" : "menu-list-iem", title: "\u6DF7\u5408\u6A21\u5F0F", onClick: function onClick() {
						return toggleMDModel("mixmin");
					} },
				_react2.default.createElement("i", { className: "fa fa-columns" })
			),
			_react2.default.createElement(
				"li",
				{ className: modelState.isPreviewModel ? "menu-list-iem active" : "menu-list-iem", title: "\u7F16\u8F91\u6A21\u5F0F", onClick: function onClick() {
						return toggleMDModel("editor");
					} },
...
var mapStateToProps = function mapStateToProps(state) {
	return { modelState: state.PanelMenuReducer.toJS() };
};

exports.default = (0, _reactRedux.connect)(mapStateToProps, { toggleFullsrceen: _index.toggleFullsrceen, toggleMDModel: _index.toggleMDModel })(PanelMenubar);
...
var _MenubarItem = __webpack_require__(111);
...
var TextMenubar = function (_Component) {
	_inherits(TextMenubar, _Component);

	function TextMenubar() {
		_classCallCheck(this, TextMenubar);

		return _possibleConstructorReturn(this, (TextMenubar.__proto__ || Object.getPrototypeOf(TextMenubar)).apply(this, arguments));
	}

	_createClass(TextMenubar, [{
		key: "render",
		value: function render() {
			var menuListData = [{
				id: "0",
				...
				functionName: _index.italicText
			}, {
				id: "2",
				isItem: false,
				isActive: false,
				...
				functionName: _index.blockquoteText
			}, {
				id: "5",
				isItem: true,
				isActive: false,
				...
				functionName: _index.pictureText
			}, {
				id: "7",
				isItem: false,
				isActive: false,
				...
				functionName: _index.listUlText
			}, {
				id: "9",
				isItem: true,
				isActive: false,
				...
				functionName: _index.listOlText
			}, {
				id: "10",
				isItem: true,
				isActive: false,
				...
				functionName: _index.headerText
			}];
			var editorDom = this.props.editorDom;
			var dispatch = this.props.dispatch;
			return _react2.default.createElement(
				"div",
				{ className: "text-menubar" },
				_react2.default.createElement(
					"ul",
					{ className: "menu-list" },
					menuListData.map(function (item) {
						return _react2.default.createElement(_MenubarItem2.default, {
							isItem: item.isItem,
							key: item.id,
							...
							onClickAction: function onClickAction() {
								return item.functionName(editorDom, dispatch);
							}
						});
					})
				)
...
exports.getEditorDom = exports.freshDocument = undefined;
...
var freshDocument = exports.freshDocument = function freshDocument(state, newDocument) {
	return state.set("mdDocument", (0, _marked2.default)(newDocument));
};

var getEditorDom = exports.getEditorDom = function getEditorDom(state, editorDom) {
...
var _MarkeCore = __webpack_require__(114);

/*


*/
var MDDOCUMENT_STATE = (0, _immutable.fromJS)({
	mdDocument: '',
	editorDom: null
});

var freshMdDocument = function freshMdDocument() {
	var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : MDDOCUMENT_STATE;
	var action = arguments[1];

	switch (action.type) {
		case _index.FRESHDOCUMENT:
			return (0, _MarkeCore.freshDocument)(state, action.mdDocument);
		case _index.GETEDITRODOM:
			return (0, _MarkeCore.getEditorDom)(state, action.editorDom);
		default:
			return state;
	}
};

exports.default = freshMdDocument;
...
var toggelmdmodel = exports.toggelmdmodel = function toggelmdmodel(state, model) {
	switch (model) {
		case "preview":
...
var togglefullscreen = exports.togglefullscreen = function togglefullscreen(state) {
	return state.update("isFullScreen", function () {
...
var _PanelCore = __webpack_require__(116);
...
var toggleFullsrceen = function toggleFullsrceen() {
	var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : INITIAL_STATE;
	var action = arguments[1];


	switch (action.type) {
		case _index.TOGGLEFULLSCREEN:
			return (0, _PanelCore.togglefullscreen)(state);
		case _index.TOGGLEMDMODEL:
			return (0, _PanelCore.toggelmdmodel)(state, action.model);
		default:
			return state;
	}
};
exports.default = toggleFullsrceen;
...
// module
exports.push([module.i, ".md-panel {\n  width: 100%;\n  min-width: 850px;\n  border: 1px solid #ccc;\n  border-radius: 3px;\n  overflow: hidden;\n  height: 557px;\n  box-sizing: border-box;\n  -moz-box-sizing: border-box;\n  -webkit-box-sizing: border-box;\n  box-shadow: inset 0 1px 1px rgba(0, 0, 0, 0.075);\n  background-color: #fff;\n  position: relative; }\n  .md-panel.md-full-screen {\n    position: absolute;\n    top: 0;\n    left: 0;\n    z-index: 9;\n    height: 100%; }\n  .md-panel .md-menubar {\n    height: 36px;\n    border-bottom: 1px solid #ccc;\n    position: absolute;\n    top: 0;\n    left: 0;\n    width: 100%;\n    z-index: 11; }\n    .md-panel .md-menubar:after {\n      content: '.';\n      display: block;\n      visibility: hidden;\n      clear: both;\n      width: 100%;\n      height: 0;\n      font-size: 0;\n      zoom: 1; }\n    .md-panel .md-menubar .text-menubar {\n      float: left;\n      width: 50%;\n      border-right: 1px solid #ccc; }\n    .md-panel .md-menubar .panel-menubar {\n      float: right; }\n    .md-panel .md-menubar .menu-list {\n      list-style: none;\n      padding: 0 5px;\n      margin: 0; }\n      .md-panel .md-menubar .menu-list:after {\n        content: '.';\n        display: block;\n        visibility: hidden;\n        clear: both;\n        width: 100%;\n        height: 0;\n        font-size: 0;\n        zoom: 1; }\n      .md-panel .md-menubar .menu-list .menu-list-iem {\n        width: 40px;\n        height: 36px;\n        text-align: center;\n        line-height: 36px;\n        cursor: pointer;\n        display: block;\n        float: left;\n        transition: background-color .3s;\n        position: relative; }\n        .md-panel .md-menubar .menu-list .menu-list-iem i {\n          color: #999;\n          transition: color .3s; }\n        .md-panel .md-menubar .menu-list .menu-list-iem.active, .md-panel .md-menubar .menu-list .menu-list-iem:hover {\n          background-color: #e9e9e9; }\n          .md-panel .md-menubar .menu-list .menu-list-iem.active i, .md-panel .md-menubar .menu-list .menu-list-iem:hover i {\n            color: #108ee9; }\n        .md-panel .md-menubar .menu-list .menu-list-iem.span-line {\n          height: 18px;\n          width: 1px;\n          background-color: #ccc;\n          margin: 9px 10px; }\n  .md-panel .md-editor-preview {\n    width: 100%;\n    height: 100%;\n    padding-top: 37px;\n    box-sizing: border-box;\n    -moz-box-sizing: border-box;\n    -webkit-box-sizing: border-box; }\n    .md-panel .md-editor-preview.full-editor .md-editor {\n      width: 100%; }\n    .md-panel .md-editor-preview.full-editor .md-preview {\n      width: 0%; }\n    .md-panel .md-editor-preview.full-preview .md-editor {\n      width: 0%; }\n    .md-panel .md-editor-preview.full-preview .md-preview {\n      width: 100%; }\n    .md-panel .md-editor-preview:after {\n      content: '.';\n      display: block;\n      visibility: hidden;\n      clear: both;\n      width: 100%;\n      height: 0;\n      font-size: 0;\n      zoom: 1; }\n    .md-panel .md-editor-preview .md-editor {\n      width: 50%;\n      height: 100%;\n      float: left;\n      transition: width .35s ease-out;\n      box-sizing: border-box;\n      -moz-box-sizing: border-box;\n      -webkit-box-sizing: border-box; }\n      .md-panel .md-editor-preview .md-editor textarea {\n        border-style: none;\n        resize: none;\n        box-sizing: border-box;\n        -moz-box-sizing: border-box;\n        -webkit-box-sizing: border-box;\n        outline: 0;\n        height: 100%;\n        width: 100%;\n        padding: 10px 15px 0; }\n    .md-panel .md-editor-preview .md-preview {\n      width: 50%;\n      height: 100%;\n      overflow: auto;\n      background-color: #f3f3f3;\n      float: right;\n      box-sizing: border-box;\n      -moz-box-sizing: border-box;\n      -webkit-box-sizing: border-box;\n      padding: 10px 20px;\n      transition: width .35s ease-out;\n      border-left: 1px solid #ccc; }\n\n.markdown {\n  width: 100%; }\n  .markdown h1, .markdown h2 {\n    padding-bottom: 8px;\n    border-bottom: 1px dotted #ccc; }\n  .markdown a {\n    color: #108ee9;\n    text-decoration: none; }\n    .markdown a:hover {\n      color: #339AFF; }\n  .markdown pre {\n    background-color: #eee;\n    color: #555;\n    border-radius: 3px;\n    padding: 10px;\n    max-height: 500px;\n    overflow: auto;\n    border: none;\n    font-size: 0.9em;\n    line-height: 1.33; }\n    .markdown pre code {\n      font-size: inherit;\n      padding: 0;\n      background-color: transparent; }\n  .markdown code {\n    color: #c7254e;\n    background-color: #eee;\n    font-size: 0.9em;\n    padding: 2px 4px; }\n  .markdown blockquote {\n    margin: 0;\n    padding: 5px 10px 5px 15px;\n    border-left: 5px solid #108ee9;\n    background-color: #eee; }\n  .markdown table {\n    border: 1px solid #108ee9; }\n    .markdown table thead tr {\n      background-color: #eee; }\n    .markdown table tbody tr {\n      border-top: 1px solid #108ee9;\n      background-color: #fff; }\n    .markdown table th, .markdown table td {\n      padding: 8px;\n      border-left: 1px solid #108ee9; }\n  .markdown hr {\n    border-style: solid;\n    border-color: #ccc; }\n", ""]);
...
var baseGetTag = __webpack_require__(146),
...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!../../node_modules/css-loader/index.js!../../node_modules/sass-loader/lib/loader.js!./ArticleTags.scss", function() {
			var newContent = require("!!../../node_modules/css-loader/index.js!../../node_modules/sass-loader/lib/loader.js!./ArticleTags.scss");
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../node_modules/css-loader/index.js!../../node_modules/sass-loader/lib/loader.js!./ArticleTitle.scss", function() {
			var newContent = require("!!../../node_modules/css-loader/index.js!../../node_modules/sass-loader/lib/loader.js!./ArticleTitle.scss");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../node_modules/css-loader/index.js!../../node_modules/sass-loader/lib/loader.js!./Marke.scss", function() {
			var newContent = require("!!../../node_modules/css-loader/index.js!../../node_modules/sass-loader/lib/loader.js!./Marke.scss");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(27), __webpack_require__(229)(module)))
